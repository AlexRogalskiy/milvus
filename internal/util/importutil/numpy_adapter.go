...
func (n *NumpyAdapter) ReadBool(count int) ([]bool, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read bool data with a zero or negative count")
...
func (n *NumpyAdapter) ReadUint8(count int) ([]uint8, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read uint8 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadInt8(count int) ([]int8, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read int8 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadInt16(count int) ([]int16, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read int16 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadInt32(count int) ([]int32, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read int32 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadInt64(count int) ([]int64, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read int64 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadFloat32(count int) ([]float32, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read float32 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadFloat64(count int) ([]float64, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read float64 data with a zero or negative count")
...
func (n *NumpyAdapter) ReadString(count int) ([]string, error) {
	if count <= 0 {
		log.Warn("Numpy adapter: cannot read varchar data with a zero or negative count")
